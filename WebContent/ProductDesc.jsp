...
<%if(request.getAttribute("success")!=null)
	 response.getWriter().println(request.getAttribute("success"));
	
	%>

<%
List<Product1> list =(List<Product1>)request.getAttribute("productList");

for(int i=0; i<list.size(); i++) {
Product1 product=list.get(i);
...
<form action="Cart" method="post"><button type="submit" name="id" value="<%= id%>">AddTOCart</button> </form>
<form action="Buy" method="post"><button type="submit" name="id" value="<%= id%>">BuyNow</button> </form>
